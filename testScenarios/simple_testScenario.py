...
class simple_testScenario(testScenario):
    def __init__(self, Config2tf, sym_filename_only):
       """Constructor for $class$"""
       super().__init__(Config2tf)
       self.read_test_symbols(Config2tf.exchange_data_folder, sym_filename_only)
       self.set_scenarios()

    def set_scenarios(self):
        s15_ADX_RSI_CCIObj = s15_ADX_RSI_CCI()
        s15_ADX_RSI_CCIObj.strategy_name = self.name+'simpleTS_ADX_RSI_BUY_SHOW'
        s15_ADX_RSI_CCIObj.withinBars = 100
       ...
       # s16_FIB_EXTObj.strategy_name = 'simpleTS_FIB_EXT_BUY_SHOW'
       # s16_FIB_EXTObj.withinBars = 100
