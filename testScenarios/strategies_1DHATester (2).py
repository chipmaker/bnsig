...
from testScenarios.HA_Buy_testScenario import HA_Buy_testScenario
...
class Strategies_1D(Strategy):
    ...
    def set_strategies(self):
        #####Test Scenario11
        TS11Dict = {}
        TS11Dict['sym_filename_only'] = 'allAssets.csv'
        TS11Dict['withinBars'] = 4
        TS11Obj = HA_Buy_testScenario(self.Config2tfObj, TS11Dict)
        self.tsObjList.append(TS11Obj)
        ####End of Test Scenario11
